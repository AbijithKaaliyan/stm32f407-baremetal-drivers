...
//	SPIpins.pGPIOx_PinConfig.GPIO_PinNumber = GPIO_PIN_NO_14;//MISO
//	GPIO_Init(&SPIpins);
...
void SPI2_Init(void){
	...
	SPI2Handle.SPIConfig.SPI_SclkSpeed = SPI_SCLK_SPEED_DIV16;   		//generate SCLK of 8MHZ since 16/2
...
int main(void)
{
	...
	//Makes NSS signals internally high and avoid MODF error
